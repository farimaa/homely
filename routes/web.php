...
Route::group(['namespace' => 'User'], function () {
	...
	Route::get('contract', 'MasterController@contract');
	Route::get('rest/security/user', 'ViewsController@currentUser');
	Route::get('rest/security/current-user', 'ViewsController@currentUser');
	Route::get('rest/i18n/ui-translations-en', 'ViewsController@translate');
	Route::get('rest/metadata/popular-cities', 'ViewsController@metaPopularCities');
	Route::get('rest/metadata/listing-metadata', 'ViewsController@metaListing');
	Route::get('rest/property/load-property/{id}', 'ViewsController@loadProperty');
	Route::get('rest/property/search-published', 'ViewsController@searchPublished');
	Route::get('rest/attachments/slides/{id}', 'ViewsController@loadPropertySlides');
	Route::get('rest/workflow/offers/load-tenant ', 'ViewsController@currentUser');

	Route::get('rest/attachments/image/{id} ', 'ViewsController@image');
	Route::group(['prefix' => 'rest/property/map'], function () {
		Route::get('landlord-all', 'PropertyController@getList');
    	Route::get('search', 'PropertyController@postBoundries');
    	Route::get('load-property/{propery_id}', 'PropertyController@getInformation');
	});
	
	Route::group(['prefix' => 'views'], function () {
		Route::get('welcome.do', 'ViewsController@welcome');
		Route::get('register.do', 'ViewsController@register');
		Route::get('login.do', 'ViewsController@login');
		Route::get('property-view.do', 'ViewsController@propertyView');
		Route::get('property-listing.do', 'ViewsController@propertyListing');
		Route::get('search-results.do', 'ViewsController@searchResults');
	});
	Route::get('list', 'HomelyController@getList');
