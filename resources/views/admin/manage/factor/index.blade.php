				...
				<form class="form-inline" method="GET">
				  	<div class="form-group">
				    	<label for="last_name">نام خانوادگی:</label>
				   	 	<input type="text" class="form-control input-sm width-80px" id="last_name" name="last_name" value="{{ 
				   	 	Request::input('last_name') }}">
				  	</div>
				  	وضعیت:
				  	<div class="form-group">
					  	<select class="form-control width-150px" name="status" id="status">
					...
					<div class="form-group">
				    	...
				    	<select class="form-control width-150px" name="role" id="role">
							<option value="">همه</option>
				  	...
				  	<div class="form-group">
				    	<input type="text" id="data-input" name="date_from" class="form-control width-80px" placeholder="تاریخ از">
				  	</div>
				  	<div class="form-group">
				    	<input type="text" id="data-input2" name="date_to" class="form-control width-80px" placeholder="تاریخ تا">
				  	</div>
